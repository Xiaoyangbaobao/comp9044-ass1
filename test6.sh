...
#second studdent submit the homework

cd "$ref_dir" || exit 1
2041 mygive-submit ass_test z51234568 multiply_right.py > "$expected_stdout" 2> "$expected_stderr"
ref_exit_code=$?

cd "$test_dir" || exit 1
./mygive-submit ass_test z51234568 multiply_ight.py  > "$actual_stdout" 2> "$actual_stderr"
exit_code=$?
